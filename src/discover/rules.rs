...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"^go\s+mod\s+(tidy|download|graph)\b",
        rtk_cmd: "rtk go mod",
        rewrite_prefixes: &["go mod"],
        category: "Go",
        savings_pct: 80.0,
        subcmd_savings: &[("tidy", 80.0), ("download", 85.0), ("graph", 70.0)],
        subcmd_status: &[],
    },
    RtkRule {
        pattern: r"^go\s+list\b",
        rtk_cmd: "rtk go list",
        rewrite_prefixes: &["go list"],
        category: "Go",
        savings_pct: 80.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"^buf\s+(lint|build|generate)\b",
        rtk_cmd: "rtk buf",
        rewrite_prefixes: &["buf"],
        category: "Go",
        savings_pct: 70.0,
        subcmd_savings: &[("lint", 75.0), ("build", 60.0), ("generate", 70.0)],
        subcmd_status: &[],
    },
    RtkRule {
        pattern: r"^goreleaser\s+(release|build|check)\b",
